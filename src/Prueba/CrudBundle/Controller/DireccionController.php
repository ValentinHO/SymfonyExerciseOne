...
use Prueba\CrudBundle\Entity\Direccion;
...
class DireccionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $direccions = $em->getRepository('PruebaCrudBundle:Direccion')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Prueba\CrudBundle\Form\DireccionType', $direccion);
    ...
    {
        $deleteForm = $this->createDeleteForm($direccion);
        $editForm = $this->createForm('Prueba\CrudBundle\Form\DireccionType', $direccion);
